...
const Info = (props) => {
    ...
    return (<>
        <div className='info_container'>
            <h4>These are instructions for your shot list, <span className='bpm_callout_text'>please read them carefully!</span></h4>
            ...
            <h4>Example <span className='bpm_callout_text'>images</span></h4>
            ...
            <h4>Image <span className='bpm_callout_text'>Appearances</span></h4>
            ...
            <h4><span className='bpm_callout_text'>Does everything look correct?</span></h4>
