...
const Info = (props) => {
    ...
    return (<>
        <div className='info_container'>
            ...
            <p>On the following pages, you'll be asked to add a description &amp; an example image for each individual shot you desire for the product in your order. We'll use this list as our sole reference when shooting and editing your images. Please let us know if you need to add any shots, update or add details before booking your shoot. <span className='bpm_strong'>Remember, if it a shot isn't listed on the following pages, you won't see it in your final images!</span></p>
            ...
            <ul>
                <li><span className='bpm_strong'>Match Example:</span> We'll match the appearance of the image as closely as possible</li>
                <li><span className='bpm_strong'>Similar to Example:</span> We'll use the example image for inspiration, but may deviate and use our own judgement as needed</li>
                <li><span className='bpm_strong'>Photogs Choice:</span> We'll take full creative control and use our best judgement to create an image that is competitive and compelling</li>
            </ul>
